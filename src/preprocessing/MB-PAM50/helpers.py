...
def to_categorical(data, dtype=None):
    ...
    for val in data:
        ...
        # I changes this to account for unknown values
...
def get_data(data):
    ...
    # I added this: Normalize RNA values
...
#     complete_data = r"../CSV_MBdata_33CLINwMiss_1KfGE_1KfCNA_v1/MBdata_33CLINwMiss_1KfGE_1KfCNA.csv"
    complete_data = 'MBdata_33CLINwMiss_1KfGE_1KfCNA.csv'
